...
public ResultSet listarCliente() {
    ...
    public int guardarCliente(String nombre, String apellido, String direccion, String telefono, String email, String sexo) throws SQLException {
        Conector db = new Conector();
        db.conectar();
        String query = "INSERT INTO clientes (nombre, apellido, direccion, telefono, email, sexo) VALUES (?, ?, ?, ?, ?, ?)";
        return db.executeUpdate(query, nombre, apellido, direccion, telefono, email, sexo);
    }
